...
for /F "delims=" %%i in (target.txt) do (
    ...
    git lfs migrate import --everything --include="*.jpg, *.jpeg, *.png, *.gif, *.psd, *.ai, *.tiff, *.tif, *.bmp, *.mp3, *.wav, *.ogg, *.aac, *.mp4, *.mov, *.mkv, *.avi, *.FBX, *.fbx, *.blend, *.obj, *.mb, *.ma, *.a, *.exr, *.tga, *.tex, *.pdf, *.zip, *.dll, *.aif, *.ttf, *.rns, *.reason, *.lxo, *.abc, *.unity, *.prefab, *.asset, *.unitypackage, *.shadergraph, *.uasset, *.umap, *.spp, *.assbin" --yes
